...
namespace DXC
{
	DrawingSwapPanel::DrawingSwapPanel() :
		...
		m_width(1.0f)
	{
		this->SizeChanged += ref new Windows::UI::Xaml::SizeChangedEventHandler(this, &DrawingSwapPanel::OnSizeChanged);
		this->CompositionScaleChanged += ref new Windows::Foundation::TypedEventHandler<SwapChainPanel^, Object^>(this, &DrawingSwapPanel::OnCompositionScaleChanged);
		Application::Current->Suspending += ref new SuspendingEventHandler(this, &DrawingSwapPanel::OnSuspending);
		Application::Current->Resuming += ref new EventHandler<Object^>(this, &DrawingSwapPanel::OnResuming);
	...
	void DrawingSwapPanel::CreateDeviceResources()
	{
	...
	void DrawingSwapPanel::CreateSizeDependentResources()
	{
	...
	void DrawingSwapPanel::CreateDeviceIndependentResources()
	{
	...
	void DrawingSwapPanel::OnSuspending(Object^ sender, SuspendingEventArgs^ e)
	{
	...
	void DrawingSwapPanel::OnSizeChanged(Object^ sender, SizeChangedEventArgs^ e)
	{
	...
	void DrawingSwapPanel::OnCompositionScaleChanged(SwapChainPanel ^sender, Object ^args)
	{
	...
	void DrawingSwapPanel::OnDeviceLost()
	{
		m_loadingComplete = false;
